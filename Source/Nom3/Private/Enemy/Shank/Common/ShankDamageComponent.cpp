...
UShankDamageComponent::UShankDamageComponent()
{
...
void UShankDamageComponent::OnHitBody(FFireInfo& Info)
{
...
void UShankDamageComponent::OnHitHead(FFireInfo& Info)
{
	...
	{
		//데미지 적용 시도
		OwnerShank->OnCriticalDamaged(Info);
